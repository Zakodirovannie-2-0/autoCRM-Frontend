...
import ClientCardHistory from "../components/ClientCardHistory.tsx";
                ...
                <div className='flex min-h-screen'>
                    ...
                    <div className="flex flex-col flex-1 ml-10">
                        ...
                        <div className='flex py-5 px-8 items-center'>
                            ...
                            <button className="bg-[#4C2A21] text-white font-semibold font-mont py-2 px-[2.594rem] rounded-md btn">СОЗДАТЬ</button>
