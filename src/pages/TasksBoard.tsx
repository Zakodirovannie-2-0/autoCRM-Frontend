            ...
            <div className='flex min-h-screen'>
                ...
                <div className="flex flex-col flex-1 ml-10">
                    ...
                    <div className="tasks-board flex flex-row justify-center mt-10 gap-5 min-h-fit h-[448px]">
                        <div
                            className={'flex flex-col max-w-xsm w-full h-full bg-gray-100 text-center rounded-md overflow-y-auto max-h-[80vh]'}>
                            <h2 className="text-lg font-semibold pt-5">К выполнению</h2>
                            <div className="mx-6 bg-[#FFFFFF] gap-6 mt-11 text-left rounded-md p-2.5">
                                <h3 className={'text-lg font-semibold'}>Задача</h3>
                                <h3 className={'mt-32 text-lg font-semibold'}>Исполнитель</h3>
                            </div>
                        </div>
                        <div
                            className={'flex flex-col max-w-xsm w-full h-md bg-gray-100 text-center rounded-md overflow-y-auto max-h-[80vh]'}>
                            <h2 className="text-lg font-semibold pt-5">В работе</h2>
                        </div>
                        <div
                            className={'flex flex-col max-w-xsm w-full bg-gray-100 text-center rounded-md overflow-y-auto max-h-[80vh]'}>
                            <h2 className="text-lg font-semibold pt-5">На проверке</h2>
                        </div>
                        <div
                            className={'flex flex-col max-w-xsm w-full bg-gray-100 text-center rounded-md overflow-y-auto max-h-[80vh]'}>
                            <h2 className="text-lg font-semibold pt-5">Готово</h2>
                        </div>
                    </div>
                </div>
            </div>
